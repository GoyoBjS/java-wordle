# with open('EJM.txt', encoding='utf-8') as f:
#     matches = ["á","é","í","ó","ú"]
#     for line in f:
#         # print(line.strip())
#         contents = f.readline()
...
with open("EJM.txt", "r+", encoding='utf-8') as f:
    d = f.readlines()
    # print(d)
    f.seek(0)
    for i in d:
...
# a_file = open("EJM.txt", "r", encoding='utf-8')
# lines = a_file.readlines()
# print(lines)
# a_file.close()

# new_file = open("EJM.txt", "w", encoding='utf-8')
# for line in lines:
